// src/platforms/perplexity/interceptor.js — Perplexity file upload interception
(function () {
    'use strict';

    var host = window.location.hostname;
    if (host !== 'perplexity.ai' && host !== 'www.perplexity.ai') return;
    ...
    document.addEventListener('change', async function (event) {
        ...
        try {
            ...
            console.warn('[Cloaker][Perplexity] File interception error:', error);
    ...
    document.addEventListener('drop', async function (event) {
        ...
        try {
            ...
            console.warn('[Cloaker][Perplexity] Drag-and-drop error:', error);
        }
    }, true);
})();